function [ LAT,LONG ] = covert_dec_degree( X ,rnd,d_m_s ) %#codgen
...
switch d_m_s
    ...
    case 'm'
        ...
        switch rnd
            ...
            case '1'
                LAT(2) = round(LAT(2)*100000)/100000;
                LONG(2) = round(LONG(2)*100000)/100000;
            otherwise
                error('Wrong flag')
        end
    ...
    case 's'
        ...
        switch rnd
            case '100'
                LAT(3) = round(LAT(3)*1000)/1000;
                LONG(3) = round(LONG(3)*1000)/1000;
            case '10'
                LAT(3) = round(LAT(3)*10000)/10000;
                LONG(3) = round(LONG(3)*10000)/10000;
            case '1'
                LAT(3) = round(LAT(3)*100000)/100000;
                LONG(3) = round(LONG(3)*100000)/100000;
            otherwise
                error('Wrong flag')
        end
